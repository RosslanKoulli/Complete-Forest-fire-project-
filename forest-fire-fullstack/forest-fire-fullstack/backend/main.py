...
That documentation is a real viva talking point: hand it to an examiner
and they can call the API themselves with no other tooling.
"""
...
from routers import predict, compare, hexmap, health
