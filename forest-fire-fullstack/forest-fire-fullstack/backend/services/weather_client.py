...
#
#   * Above the tree line in Mediterranean / temperate latitudes: roughly
#     2500m absolute, though it varies. We use this as a documented
#     threshold. Above this elevation there is rock, snow, or alpine
#     meadow but not forest. This catches the High Atlas, Pyrenees,
#     Alps, and the highest stretches of the Apennines.
#
...
#   * Glaciers below 2500m (rare in our scope but possible).
